...
<template x-teleport="body">
    <div
        ...
        class="sticky h-screen inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div
            @click.outside="open = false"
            class="bg-white rounded-lg shadow-lg w-3/4  p-6 ">
            <!-- Bezárás gomb -->
            <button @click="open = false" class=" top-4 left-4 text-red-500 hover:text-red-800 text-2xl">
                ✖
            </button>
